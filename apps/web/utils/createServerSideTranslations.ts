...
import type { Locale } from 'web-locales/types/locales';
import { defaultLocale } from 'web-locales/types/locales';
import type { Namespace } from 'web-locales/types/namespaces';
